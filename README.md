...
** In the demo video I first reset the ESP32 controller to boot up fresh, then leave the controller on the leveled surface of my desk to calibrate, and then I jam my Ableton preset with the controller. The bandpass frequency filter used in the demo video is my DIY VST3 filter made with JUCE shown [here](https://github.com/Amphicheiras/BandpassFilter).**
## 1. Introduction
